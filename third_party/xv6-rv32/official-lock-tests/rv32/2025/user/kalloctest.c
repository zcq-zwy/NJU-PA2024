...
#define N4 100
#define SZ 4096
#define RV32_SBRK_ERROR ((uint32)-1)
#define COUNTFREE_LIMIT 512
...
void test2() {
  ...
  int free1;
  printf("start test2\n");  
  printf("sampled free number of pages: %d\n", free0);
  if(free0 < 128) {
